...
#[ApiResource(
    operations: [
        // GET collection (liste des events)
        new GetCollection(),

        // GET un event spécifique
        new Get(),

        // POST : création d’un event (l’utilisateur connecté devient automatiquement créateur)
        new Post(
          //  security: "is_granted('ROLE_USER')",
            processor: EventProcessor::class
        ),

        // PATCH : seul le créateur peut modifier
        new Patch(security: "object.getCreator() == user"),

        // DELETE : seul le créateur peut supprimer
        new Delete(security: "object.getCreator() == user"),
    ]
)]
